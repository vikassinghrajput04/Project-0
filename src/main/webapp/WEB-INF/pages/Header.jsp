...
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top"
		style="background-color: #0f82f6;">
	<div class="container-fluid">
		<ul class="nav navbar-nav navbar-left"
			style="background-color: #3030358f">
			<a href="<c:url value="/Welcome" />"></a>
			<img src="/Project-0/resources/image/IMG/customLogo.png" width="130"
			...
			<ul class="nav navbar-nav navbar-right" style="background:">
				<c:if test="${empty sessionScope.user}">
				    <li class ="dropdown" > <a href="" id="dcolor"
						...
						<s:message code="label.hiGuest"></s:message><span class="caret"></span><br>
						</a>
					...
					<li><a href="<c:url value="/Login" />" 
						...
						style="width: auto; font-family: cursive;"><span
							class="glyphicon glyphicon-log-in"
							style="font-size: 20px; margin-right: 8px;"></span> <b><s:message
								code="header.login"></s:message></b></a></li>
					<li><a href="<c:url value="/UserRegistration" />" >
							<font style="font-family: cursive; color: black"> <span
								class="glyphicon glyphicon-user"
								style="font-size: 20px; margin-right: 10px;"></span>
							<b><s:message code="header.userRegistration"></s:message></b></font>
...
--%>
	...
	<div style="margin-right: 80px;" class="dropdown">
		<button class="btn btn-info" id="btn"
			style="background-color: #0f82f6; "type="button"
			data-toggle="dropdown"><font color="black"><b style="font-family:cursive; color: white"><s:message
						code="language.hindi"></s:message></b></font><font color="white">&nbsp;<span
				class="caret"></span></font><br>
		</button>
