						...
						<div class="panel-body">
							...
							<legend align="center">
								<font size="5"><b><s:message
											code="login.lebel.userRegistration"></s:message></b></font>
							</legend>
							<br>
							...
							<div class="col-xs-12 col-sm-12 col-md-10 col-lg-12">
								...
								<s:message code="user.placeholder.confirmPassword"
									var="confirmPassword"></s:message>
								...
								<div class="form-group" style="margin-left: 10%;">
									<label align="left" class="control-label text-info col-md-6">
										<s:message code="user.label.password" /> <span
										style="color: red;">*</span>
									</label>
								...
								<div class="form-group" style="margin-left: 10%;">
									...
									<div class="col-md-12" style="margin-bottom: 10px;">
										<div class="input-group">
											...
											<sf:input path="mobileNo" maxlength="10"
												placeholder="${mobileNo}" class="form-control" />
										</div>
								...
								<div class="form-group" style="margin-left: 10%;">
									...
									<div class="col-md-12" style="margin-bottom: 10px;">
										<div class="input-group">
											...
											<sf:input path="dob" placeholder="${dob}" readonly="true"
