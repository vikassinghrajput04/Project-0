...
#user {
	top: 30px;
	background-color: rgb(236, 35, 21);
}

#role {
	top: 80px;
	background-color: rgb(20, 220, 100);
}

#college {
	top: 130px;
	background-color: rgb(19, 40, 226);
}

#student {
	top: 180px;
	background-color: rgb(235, 174, 20);
}

#faculty {
	top: 230px;
	background-color: rgb(243, 15, 160);
}
...
#subject {
	top: 330px;
	background-color: rgb(44, 61, 160);
}

#marksheet {
	top: 380px;
	background-color: rgb(248, 127, 14);
}

#timetable {
	top: 430px;
	background-color: rgb(13, 206, 236);
}
</style>
